...
def main():
    ...
    cocos_root2 = os.path.abspath(os.path.join(project_root, '..', '..'))
    ...
    config.set('DEFAULT', 'cocosdir', cocos_root2)
    ...
    try:
        ...
        output_dir = '%s/../runtime-src/Classes/script' % project_root

        cmd_args = {'auto_bind_test.ini' : ('autobind', 'lua_bind_test_auto'), \
                    }
        target = 'lua'
